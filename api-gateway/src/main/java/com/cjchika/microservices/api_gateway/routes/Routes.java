package com.cjchika.microservices.api_gateway.routes;
...
public class Routes {
    ...
    public RouterFunction<ServerResponse> orderServiceSwaggerRoute(){
        return route("order_service_swagger")
                ...
                .filter(CircuitBreakerFilterFunctions.circuitBreaker("orderSwaggerCircuitBreaker",
                        URI.create("forward:/fallbackRoute")))
                .filter(setPath("/api/docs"))
                .build();
    }
    ...
    public RouterFunction<ServerResponse> inventoryServiceSwaggerRoute(){
        return route("inventory_service_swagger")
                ...
                .filter(CircuitBreakerFilterFunctions.circuitBreaker("inventorySwaggerCircuitBreaker",
                        URI.create("forward:/fallbackRoute")))
                .filter(setPath("/api/docs"))
                .build();
    }
